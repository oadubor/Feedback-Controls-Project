classdef FeedbackRobotVisualizer2D < handle
    ...
    methods(Access = public)
        ...
        function this = FeedbackRobotVisualizer2D(numFrames, axisLength, coordLength, createNewFig)
